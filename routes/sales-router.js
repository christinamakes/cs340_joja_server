...
router.put('/update-s', function(req,res,next){
    ...
    if (employee_id === 'NULL') {
        ...
        db.connection.query(queryUpdateSale, [{member_id:member_id, employee_id:'NULL', purchase_date:purchase_date,invoice_total:invoice_total},order_number], function(error, rows, fields){
            if (error) {
